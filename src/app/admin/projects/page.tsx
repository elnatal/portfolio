          ...
          <TableBody>
            ...
            {projects.map((project) => (
              ...
              >
                ...
                <TableCell>
                  {project.featured ? (
                    <Badge className="bg-violet-600/20 text-violet-300 border-violet-500/40 text-xs">
                      Featured
                    </Badge>
                  ) : (
                ...
                <TableCell className="text-center">
                  <VisibilityToggle id={project.id} visible={project.visible} endpoint="/api/projects" />
                </TableCell>
